...
public class BoardSearchImpl extends QuerydslRepositorySupport implements BoardSearch{
    ...
    public Page<Board> searchAll(String[] types, String keyword, Pageable pageable) {
        ...
        QBoard board = QBoard.board; // q 도메인 객체  entity를 Qboard로 바꾼 것
...
//    @Override
//    public Page<Board> searchAll(String[] types, String keyword, LocalDate  localDate, Pageable pageable) {
//
...
//                        break;
//                    case "f":
//                        booleanBuilder.and(board.regdate.before(localDate));
//                        break;
//                }// swich
//                //만약에 tc가 들어왔다면 where문 이후  title like %키워드% or content like %키워드%
//
